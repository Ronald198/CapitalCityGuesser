...
import 'package:capitalcityguesser/pages/capitals_catalog_page.dart';
            ...
            child: Column(
              ...
              children: [
                const Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    Text("Capital City Guesser", style: TextStyle(fontSize: 24, color: Colors.white),),
